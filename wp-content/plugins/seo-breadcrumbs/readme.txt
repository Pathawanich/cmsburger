...
Tags: seo, breadcrumbs, seo breadcrumbs, easy navigation, list, menu
...
* If you need any help see [Plugin Website](https://krnmsaikrishna.wordpress.com/plugins/seo-breabcrumbs).

== Installation ==

 1. Download the plugin.
 2. Unzip the `seo-breadcrumbs` package and upload the file to your WordPress installation’s `plugins` folder.
 3. Enable the plugin by clicking activate button.
 4. Adjust any settings you want under `Settings -> SEO Breadcrumbs`
 5. **Widget Mode :** add a widget under `Widgets -> SEO Breadcrumbs`
    **Developer Mode :**  add below code on your theme template file where you want.
    ...
    ?>`
    **Shortcode Mode :** use the `[seo-breadcrumbs]` shortcode for easy use.
 6. Nothing else to do. That's it!

You will find *SEO Breadcrumbs* menu in your WordPress admin panel to access plugin settings. 

For basic usage, you can also have a look at the [Plugin Website](https://krnmsaikrishna.wordpress.com/plugins/seo-breabcrumbs).

== Frequently Asked Questions ==

= What is use of breadcrumbs in websites ? =
...
You can follow this instructions. Go to `Appearance > Widgets > SEO Breadcrumbs` enter the title and click on save. that's it!



== Screenshots ==

1. Customize this plugin from this Setting page like this on SEO Breadcrumbs settings option. That's it!
2. Eight different stunning styles for your breadcrumbs.
3. Add this widget on widget area, by drag and drop the SEO Breadcrumbs widget.
...
= 2.0 = 
New styles and light-fast breadcrumbs generation algorithm with schema markup, google rich snippet compatible...
