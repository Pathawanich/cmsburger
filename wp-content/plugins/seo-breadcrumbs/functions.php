...
// function for building list items.
  function crumb_builder ( $href, $title, $name, $tag, $pos )
 {
  return "\n" . '<li itemprop="itemListElement" class="breadcrumbs-item" itemscope itemtype="http://schema.org/ListItem">
   <a itemprop="item" href="' .$href.'" title="'.$title.'" class="crumb">
...
$style_xml = plugins_url('/xml/styles.xml',__FILE__);
$styles = simplexml_load_file($style_xml);
...
echo '<div class="'.$breadcrumbs_class.'">
  <ol id="'.$breadcrumbs_id.'" itemscope itemtype="http://schema.org/BreadcrumbList">'."\n";
