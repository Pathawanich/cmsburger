...
function whitedot_notice_theme_install_1i() {
    $users_id = get_current_user_id();
    if ( !get_user_meta( $users_id, 'whitedot_notice_dismissed_theme_install_1i' ) ) {
    	?>
		<div class="notice notice-success whitedot-notice">
		<p><b><?php _e( 'Thank you for Installing/Updating Whitedot!!', 'whitedot' ); ?></b><br><br><?php _e( 'It took 5 months of hard work to build this theme for you. I hope you like it :) ', 'whitedot' ); ?><br><?php _e( 'And if you do like the theme, could you please do me a BIG favor and give it a 5-star rating on WordPress? I really need your help to spread the popularity of this new theme.', 'whitedot' ); ?></p>
		<a class="whitedot-notice-btn" target="_blank" href="https://wordpress.org/support/theme/whitedot/reviews/#new-post">Go to Review Page</a><br><br>
		<p><?php _e( 'And if you have any issues, feature ideas or any questions related this theme, please let me know.', 'whitedot' ); ?></p>
		<a class="whitedot-notice-btn" target="_blank" href="https://wordpress.org/support/theme/whitedot">Support Page</a>
		<a class="whitedot-notice-btn" target="_blank" href="https://www.facebook.com/groups/zeetheme">Join Facebook Group</a>
		<a href="?whitedot-dismissed-theme-install-1i">
...
add_action( 'admin_notices', 'whitedot_notice_theme_install_1i' );

function whitedot_notice_dismissed_theme_install_1i() {
    $users_id = get_current_user_id();
    if ( isset( $_GET['whitedot-dismissed-theme-install-1i'] ) )
        add_user_meta( $users_id, 'whitedot_notice_dismissed_theme_install_1i', 'true', true );
}
add_action( 'admin_init', 'whitedot_notice_dismissed_theme_install_1i' );
