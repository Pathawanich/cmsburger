...
function whitedot_scripts() {
	...
	wp_enqueue_style('whitedot-style-minified', get_stylesheet_directory_uri() . '/css/minified/main-style.min.css', array(), '1.0.0' );
...
function whitedot_enqueue_custom_admin_style() {
        wp_register_style( 'whitedot-admin-css', get_template_directory_uri() . '/css/unminified/admin.css', false, '1.0.2' );
